/*
  ...
  1. New Tables
    ...
    - `products` - Complete product catalog with pricing models
    - `customers` - Customer management with contact details
    - `customer_down_payments` - Customer advance payments tracking
    - `quotes` - Quote/order management system
    - `quote_items` - Detailed quote line items with area calculations
    - `suppliers` - Supplier management and contact information
    - `supplier_debts` - Debt tracking with suppliers
    - `supplier_credits` - Payment tracking to suppliers
    - `accounts_payable` - Bills and installment management
    - `app_users` - System user management with roles and authentication
...
-- Create index for customer down payments
...
-- Create index for supplier debts
...
-- Create index for supplier credits
